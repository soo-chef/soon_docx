...
if load_btn or 'records' in st.session_state:
    ...
    headers = [
        '성명', '입소일', '생년월일', '성별', '신장', '평소체중', '등급', '식사유형',
        '1일필요열량', '1일필요단백질', '식사방법', '식사섭취상태', '식사속도',
        '도구_젓가락', '도구_숟가락', '도구_포크숟가락', '도구_불가',
        '문제_식욕저하', '문제_저작곤란', '문제_연하곤란', '문제_소화불량', '문제_구토', '문제_없음',
        '치아상태', '소화기능', '배설양상', '특이체질내용', '주요진단명',
        '질환_당뇨', '질환_고혈압', '질환_심장질환', '질환_뇌혈관질환',
        '질환_신장질환', '질환_간질환', '질환_암', '질환_기타내용',
        '복용약물내용', '약물영향_식욕저하', '약물영향_구역구토',
        '약물영향_미각변화', '약물영향_흡수장애', '약물영향_기타내용',
